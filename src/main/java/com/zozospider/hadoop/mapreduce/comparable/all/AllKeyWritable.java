 ...
 * 实现 Writable 接口
 */
public class AllKeyWritable implements WritableComparable<AllKeyWritable> {
    ...
    @Override
    public int compareTo(AllKeyWritable o) {
        // 按 fieldSum 倒叙排列
